...
class LimitOrder(Order):
    ...
    def __init__(self, agent_id, time_placed, symbol, quantity, is_buy_order, limit_price, order_id=None, tag=None, market_impact = True):
    ...
    def __deepcopy__(self, memodict={}):
        ...
        order = LimitOrder(agent_id, time_placed, symbol, quantity, is_buy_order, limit_price,
                           order_id=order_id, tag=tag, market_impact=market_impact)
