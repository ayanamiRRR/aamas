...
class MarketOrder(Order):
    ...
    def __init__(self, agent_id, time_placed, symbol, quantity, is_buy_order, order_id=None, tag=None, market_impact=True):
    ...
    def __deepcopy__(self, memodict={}):
        ...
        market_impact = deepcopy(self.market_impact, memodict)

        # Create new order object
        order = MarketOrder(agent_id, time_placed, symbol, quantity, is_buy_order, order_id=order_id, tag=tag, market_impact=market_impact)
