...
class MomentumAgent(TradingAgent):
    ...
    def __init__(self, id, name, type, symbol, starting_cash,wake_up_freq=60,
        ...
        self.mid_list, self.avg_20_list, self.avg_50_list = list(random_state.uniform(-3,3,50) + 999.5), [], []
    ...
    def kernelTerminating(self):
        ...
        np.save('./log/{}/{}/event_ls_momentum_{}_{}.npy'.format(self.folder_name,self.seed,self.id,self.market_impact),np.array(self.event_ls))
